...
const STATIC_FILES=["./index.html","./quran.html","./register.html","./login.html","./manifest.webmanifest","./assets/logos/academy-logo-full.png","./assets/icons/icon-192.png","./assets/icons/icon-512.png"];
