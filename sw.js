const CACHE_NAME = "rasheed-academy-pwa-v4";
const STATIC_FILES = ["./index.html", "./quran.html", "./register.html", "./login.html", "./manifest.webmanifest", "./assets/logos/academy-logo-full.png", "./assets/icons/icon-192.png", "./assets/icons/icon-512.png", "./assets/icons/apple-touch-icon.png", "./assets/css/pwa.css", "./assets/js/pwa.js"];
